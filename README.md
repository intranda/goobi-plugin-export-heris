# Goobi workflow Plugin: goobi-plugin-export-heris
...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/export/goobi-plugin-export-heris
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/export/goobi-plugin-export-heris
